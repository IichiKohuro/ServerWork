...
namespace ServerHost
{
    public class ServicesViewModel : BaseViewModel
    {
        ...
        /// </summary>
        public string ServiceStatusTrayToolTip { get; set; } = "Сервис отправки заявок: Отключен ...";
        ...
        public ServicesViewModel()
        {
            ...
            ServiceStatusTrayToolTip = "Сервис отправки заявок: Отключен ...";
            ...
            SendMailOnDemandCommand = new RelayCommand(() => SendMailOnDemand());
            ...
            if (bool.Parse(ini.Read("MainConfiguration", "AutostartSendBidService")))
                MailServiceDialog();
        ...
        private void SendMailOnDemand()
        {
            if (host != null)
            {
                ...
                if (host.State == CommunicationState.Opened)
                {
                    ...
                    LoadingContent = new LoadView("Отправка заявок, ждите ...");
                    IsDialogOpen = true;
                    ...
                    Task.Factory.StartNew(() =>
                    {
                        ...
                        // Отправка заявок сервис. обслуживанию по требованию пользователя
        ...
        private void MailServiceDialog()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                if (StateService == false)
                {
                    ...
                    // Логгируем действие
                    logger.WriteLog(this.ToString(), "Запуск сервиса отправки заявок ...", LogType.Information, out string error);

                    ServiceStatus = "Сервис запущен ...";
                    ServiceStatusTrayToolTip = "Сервис отправки заявок: Работает ...";
                ...
                else
                {
                    ...
                    // Логгируем действие
                    logger.WriteLog(this.ToString(), "Остановка сервиса отправки заявок ...", LogType.Information, out string error);
        ...
        /// </summary>
        public ICommand SendMailOnDemandCommand { get; }
